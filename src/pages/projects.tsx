                                ...
                                <blockquote>
                                    <div className="relative">
                                        ...
                                        <p className="relative text-base text-gray-500">
                                            ...
                                            consulting were an absolute joy to
                                            work with. The whole process was
                                            outlined out for us before we
                                            started so we knew exactly what to
                                            expect. When it comes to Netsuite
                                            website customization at an
                                            affordable and fair price... Fourth
                                            Wave is your answer!!!&rdquo;
                                        </p>
                                    </div>
