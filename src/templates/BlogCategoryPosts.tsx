		...
		<Layout location={props.location}>
			...
			<div className="relative bg-gray-500">
				...
				<div className="relative max-w-7xl mx-auto py-24 px-4 sm:px-6 lg:px-8">
					...
					<h1 className="text-4xl font-extrabold tracking-tight text-white sm:text-5xl lg:text-6xl m-0">Browsing By Category: <span className="text-blue-500">{capitalizeFirstLetter(props.pathContext.slug)}</span></h1>
				</div>
			</div>
			<Row gutter={36}>
