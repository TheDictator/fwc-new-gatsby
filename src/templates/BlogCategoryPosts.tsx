		...
		<Layout location={props.location}>
			...
			<div className="relative bg-gray-500">
				...
				<span className="block bg-gradient-to-r from-blue-300 to-blue-300 bg-clip-text text-transparent text-base font-semibold tracking-wide uppercase">Blog</span>
					<h1 className="text-4xl font-extrabold tracking-tight text-white sm:text-5xl lg:text-6xl m-0">Browsing By Category: <span className="bg-gradient-to-r from-blue-300 to-blue-300 bg-clip-text text-transparent">{capitalizeFirstLetter(props.pathContext.slug)}</span></h1>
				</div>
			</div>
			<Row gutter={36}>
